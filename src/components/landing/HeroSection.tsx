          ...
          <div className="text-white space-y-8 animate-fade-in-up">
            ...
            <div className="pt-8 border-t border-white/10">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                >
                  <div className="bg-black rounded-lg px-4 py-2 min-w-[135px] h-[40px] flex items-center gap-2 border border-white/10">
                    ...
                    <div className="flex flex-col justify-center -space-y-0.5">
                      <span className="text-[8px] text-white font-normal leading-none tracking-tight" style={{ letterSpacing: '0.01em' }}>Download on the</span>
                      <span className="text-[17px] text-white font-semibold leading-none tracking-tight" style={{ fontFamily: 'SF Pro Display, -apple-system, BlinkMacSystemFont, sans-serif', letterSpacing: '-0.01em' }}>App Store</span>
                    </div>
                  </div>
                </a>
