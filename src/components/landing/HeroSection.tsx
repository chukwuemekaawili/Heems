          ...
          <div className="text-white space-y-8 animate-fade-in-up">
            ...
            <div className="pt-8 border-t border-white/10">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                >
                  <div className="flex items-center gap-2 px-5 py-2.5 bg-black rounded-lg border border-white/20 hover:border-white/40 transition-colors">
                    ...
                    <div className="text-left">
                      <div className="text-[9px] text-white/90 font-normal leading-tight tracking-wide">Download on the</div>
                      <div className="text-[19px] text-white font-semibold leading-tight -mt-0.5" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", sans-serif' }}>App Store</div>
                    </div>
                  </div>
                </a>
